...
if (strlen($_SESSION['alogin']) == "") {
    ...
    <head>
        ...
        <style>
            ...
            .fc-widget-header th {
                background-color: #fac863 !important;
            }
            .fc-today{
                ...
                <div class="main-page">
                    <div class="container-fluid">
                        <div class="row page-title-div">
                            <div class="col-sm-6">
                                <h2 class="title">Maternity Leave Dashboard</h2>
                    ...
                    <!-- /.container-fluid -->
<?php include("maternityLeaveSummery.php"); ?>
                            ...
                            <div class="col-md-3">
                                <div class="panel-group">
                                    <div class="panel panel-success">
                                        ...
                                        <div class="panel-body"><b style="font-size:12px;font-weight: bold;">(Select Leave to See Details)</b><br>
                                           Name:  <span id="empName"></span><br>
                                           Designation:  <span id="empDesignation"></span><br>
                                           Location:  <span id="empPresentWorkingPlace"></span><br>
                                            Leave Starts: <span id="leaveStart"></span><br>
                                            Leave Ends: <span id="leaveEnd"></span>
                                        </div>
                                    </div>
                                    <div class="panel panel-success">
        ...
        $(document).ready(function() {
            ...
            $('#calendar').fullCalendar({
                    ...
                    if(sizeof($MaternityLeaveArr)>0){
                        for($i = 0 ; $i<sizeof($MaternityLeaveArr);$i++){
                            echo "{title: '".
                                ...
                                $MaternityLeaveArr[$i]->maternityLeaveFrom. "', end: '".
                                $MaternityLeaveArr[$i]->maternityLeaveTo."', designation: '".
                                $MaternityLeaveArr[$i]->designation."', presentWorkingPlace: '".
                                $MaternityLeaveArr[$i]->presentWorkingPlace. "', empPhoto: '".
                ...
                eventClick: function(info) {
                    $("#empPhoto").attr('src',imgUserBlnk)
                    $("#empName").text(info.title)
                    $("#empDesignation").text(info.designation)
                    $("#empPresentWorkingPlace").text(info.presentWorkingPlace)
                    $("#leaveStart").text(moment(info.start).format("DD/MM/YYYY"))
                    $("#leaveEnd").text(moment(info.end).format("DD/MM/YYYY"))
